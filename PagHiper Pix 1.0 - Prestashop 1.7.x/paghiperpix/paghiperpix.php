...
class PagHiperPix extends PaymentModule
{
	...
	{
		if((isset($this->context->controller->php_self) && $this->context->controller->php_self == 'order') || (isset($_GET['module']) && $_GET['module']=='paghiperpix')){
    ...
    public function install()
    {
		...
		$parent_tab0->class_name = 'AdminPagHiperPixGeral';
